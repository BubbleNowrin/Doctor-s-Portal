...
const AddDoctor = () => {
    ...
    const { data: specialties, isLoading } = useQuery({
        queryKey: ['specialty'],
        queryFn: async () => {
            const res = await fetch(`https://doctors-portal-server-pied-ten.vercel.app/appointmentSpecialty`)
        ...
        fetch(`https://api.imgbb.com/1/upload?key=${imageHostKey}`, {
            ...
            .then(imgData => {
                ...
                if (imgData.success) {
                    ...
                    fetch('https://doctors-portal-server-pied-ten.vercel.app/doctors', {
                        method: 'POST',
                        headers: {
        ...
        <div className='w-96 p-7'>
            ...
            <form onSubmit={handleSubmit(handleAddDoctor)}>
                ...
                <div className="form-control w-full max-w-xs">
                    ...
                    <select
                        {...register('specialty')} className="select input-bordered w-full max-w-xs">
                ...
                <div className="form-control w-full max-w-xs">
                    ...
                    <input type="file" className="input input-bordered w-full max-w-xs"  {...register("photo", {
